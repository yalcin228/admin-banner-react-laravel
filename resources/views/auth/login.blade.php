...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('admin/admin-panel/assets/vendor/css/pages/page-auth.css') }}"/>
    <!-- Helpers -->
                ...
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                          <g id="Icon" transform="translate(27.000000, 15.000000)">
                            ...
                            <span class="app-brand-text demo text-body fw-bolder">Admin-Banner</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="username" name="username" class="form-label">Email or Username</label>
                            <input
                                type="text"
